...
export const ui = {
  ...
  btnRescanLibrary: document.getElementById('btn-rescan-library'),
  ...
  // QQ 音乐 UI 元素
  navQQMusic: document.getElementById('nav-qqmusic'),
  viewQQMusic: document.getElementById('view-qqmusic'),
  qqmusicConfigGate: document.getElementById('qqmusic-config-gate'),
  qqmusicContent: document.getElementById('qqmusic-content'),
  qqmusicKeywordsInput: document.getElementById('qqmusic-global-input'),
  qqmusicResultList: document.getElementById('qqmusic-result-list'),
  qqmusicSelectAll: document.getElementById('qqmusic-select-all'),
  qqmusicBulkDownload: document.getElementById('qqmusic-bulk-download'),
  qqmusicBulkActions: document.getElementById('qqmusic-bulk-actions'),
  qqmusicDownloadList: document.getElementById('qqmusic-download-list'),
  qqmusicDownloadPanel: document.getElementById('qqmusic-download-panel'),
  qqmusicDownloadToggle: document.getElementById('qqmusic-download-toggle'),
  qqmusicDownloadFloating: document.getElementById('qqmusic-download-floating'),
  qqmusicApiGateInput: document.getElementById('qqmusic-api-gate-input'),
  qqmusicApiGateBtn: document.getElementById('qqmusic-api-gate-btn'),
  qqmusicApiSettingsInput: document.getElementById('qqmusic-api-settings-input'),
  qqmusicDownloadDirInput: document.getElementById('qqmusic-download-dir'),
  qqmusicQualitySelect: document.getElementById('qqmusic-quality-select'),
  qqmusicSaveSettingsBtn: document.getElementById('qqmusic-save-settings-btn'),
  qqmusicDisconnectBtn: document.getElementById('qqmusic-disconnect-btn'),
  qqmusicLoginBtnTop: document.getElementById('qqmusic-login-btn-top'),
  qqmusicUserDisplay: document.getElementById('qqmusic-user-display'),
  qqmusicUserName: document.getElementById('qqmusic-user-name'),
  qqmusicUserAvatar: document.getElementById('qqmusic-user-avatar'),
  qqmusicVipBadge: document.getElementById('qqmusic-vip-badge'),
  qqmusicUserMenu: document.getElementById('qqmusic-user-menu'),
  qqmusicMenuLogout: document.getElementById('qqmusic-menu-logout'),
  qqmusicQrModal: document.getElementById('qqmusic-qr-modal'),
  qqmusicQrImg: document.getElementById('qqmusic-qr-img'),
  qqmusicQrHint: document.getElementById('qqmusic-qr-hint'),
  closeQQMusicQrModal: document.getElementById('close-qqmusic-qr-modal'),
  // 手机登录相关
  qqmusicTabQr: document.getElementById('qqmusic-tab-qr'),
  qqmusicTabPhone: document.getElementById('qqmusic-tab-phone'),
  qqmusicTabCookie: document.getElementById('qqmusic-tab-cookie'),
  qqmusicQrPanel: document.getElementById('qqmusic-qr-panel'),
  qqmusicPhonePanel: document.getElementById('qqmusic-phone-panel'),
  qqmusicCookiePanel: document.getElementById('qqmusic-cookie-panel'),
  qqmusicPhoneInput: document.getElementById('qqmusic-phone-input'),
  qqmusicCodeInput: document.getElementById('qqmusic-code-input'),
  qqmusicSendCodeBtn: document.getElementById('qqmusic-send-code-btn'),
  qqmusicPhoneHint: document.getElementById('qqmusic-phone-hint'),
  qqmusicPhoneLoginBtn: document.getElementById('qqmusic-phone-login-btn'),
  // Cookie 登录相关
  qqmusicCookieMusicid: document.getElementById('qqmusic-cookie-musicid'),
  qqmusicCookieMusickey: document.getElementById('qqmusic-cookie-musickey'),
  qqmusicCookieHint: document.getElementById('qqmusic-cookie-hint'),
  qqmusicCookieLoginBtn: document.getElementById('qqmusic-cookie-login-btn'),
  ...
  addToPlaylistList: document.getElementById('add-to-playlist-list'),
  closeAddToPlaylistModal: document.getElementById('close-add-to-playlist-modal'),
  btnCreatePlaylistInModal: document.getElementById('btn-create-playlist-in-modal'),
  // 新建歌单弹窗
  ...
  // 定位当前播放歌曲按钮
  btnLocatePlaying: document.getElementById('btn-locate-playing')
};
